...
add wave -noupdate -group fetch -color Magenta -radix hexadecimal /tb_cpu/dut/pipeline_inst/fetch_inst/instr
...
add wave -noupdate -group decode -childformat {{/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.reg -radix unsigned} {/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.data -radix hexadecimal}} -subitemconfig {/tb_cpu/dut/pipeline_inst/decode_inst/reg_write.reg {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/decode_inst/reg_write.data {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/decode_inst/reg_write
add wave -noupdate -group decode -childformat {{/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.rs1 -radix unsigned} {/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.rs2 -radix unsigned} {/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.readdata1 -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.readdata2 -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.imm -radix hexadecimal}} -subitemconfig {/tb_cpu/dut/pipeline_inst/decode_inst/exec_op.rs1 {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/decode_inst/exec_op.rs2 {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/decode_inst/exec_op.readdata1 {-height 16 -radix hexadecimal} /tb_cpu/dut/pipeline_inst/decode_inst/exec_op.readdata2 {-height 16 -radix hexadecimal} /tb_cpu/dut/pipeline_inst/decode_inst/exec_op.imm {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/decode_inst/exec_op
...
add wave -noupdate -group mem -radix hexadecimal /tb_cpu/dut/pipeline_inst/memory_inst/aluresult_in
add wave -noupdate -group mem -radix hexadecimal /tb_cpu/dut/pipeline_inst/memory_inst/aluresult_out
add wave -noupdate -group mem -childformat {{/tb_cpu/dut/pipeline_inst/memory_inst/reg_write.reg -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/memory_inst/reg_write.data -radix hexadecimal}} -subitemconfig {/tb_cpu/dut/pipeline_inst/memory_inst/reg_write.reg {-height 16 -radix hexadecimal} /tb_cpu/dut/pipeline_inst/memory_inst/reg_write.data {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/memory_inst/reg_write
add wave -noupdate -group mem -childformat {{/tb_cpu/dut/pipeline_inst/memory_inst/mem_in.rddata -radix hexadecimal}} -subitemconfig {/tb_cpu/dut/pipeline_inst/memory_inst/mem_in.rddata {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/memory_inst/mem_in
add wave -noupdate -group mem -childformat {{/tb_cpu/dut/pipeline_inst/memory_inst/mem_out.address -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/memory_inst/mem_out.wrdata -radix hexadecimal}} -subitemconfig {/tb_cpu/dut/pipeline_inst/memory_inst/mem_out.address {-height 16 -radix hexadecimal} /tb_cpu/dut/pipeline_inst/memory_inst/mem_out.wrdata {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/memory_inst/mem_out
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/op
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/A
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/W
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/R
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/XL
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/XS
add wave -noupdate -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/D
add wave -noupdate -group mem -group memu -childformat {{/tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M.address -radix hexadecimal} {/tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M.wrdata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M.address {-height 16 -radix hexadecimal} /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M.wrdata {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M
...
add wave -noupdate -group wb -childformat {{/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg -radix unsigned -childformat {{/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(4) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(3) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(2) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(1) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(0) -radix unsigned}}} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.data -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg {-height 16 -radix unsigned -childformat {{/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(4) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(3) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(2) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(1) -radix unsigned} {/tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(0) -radix unsigned}}} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(4) {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(3) {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(2) {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(1) {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.reg(0) {-height 16 -radix unsigned} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write.data {-height 16 -radix hexadecimal}} /tb_cpu/dut/pipeline_inst/writeback_inst/reg_write
add wave -noupdate -divider -height 40 Cache
add wave -noupdate -group Cache -childformat {{/tb_cpu/dut/cache_inst/cpu_to_cache.address -radix hexadecimal} {/tb_cpu/dut/cache_inst/cpu_to_cache.wrdata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/cache_inst/cpu_to_cache.address {-radix hexadecimal} /tb_cpu/dut/cache_inst/cpu_to_cache.wrdata {-radix hexadecimal}} /tb_cpu/dut/cache_inst/cpu_to_cache
add wave -noupdate -group Cache -childformat {{/tb_cpu/dut/cache_inst/cache_to_cpu.rddata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/cache_inst/cache_to_cpu.rddata {-radix hexadecimal}} /tb_cpu/dut/cache_inst/cache_to_cpu
add wave -noupdate -group Cache -childformat {{/tb_cpu/dut/cache_inst/cache_to_mem.address -radix hexadecimal} {/tb_cpu/dut/cache_inst/cache_to_mem.wrdata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/cache_inst/cache_to_mem.address {-radix hexadecimal} /tb_cpu/dut/cache_inst/cache_to_mem.wrdata {-radix hexadecimal}} /tb_cpu/dut/cache_inst/cache_to_mem
add wave -noupdate -group Cache -childformat {{/tb_cpu/dut/cache_inst/mem_to_cache.rddata -radix hexadecimal}} -expand -subitemconfig {/tb_cpu/dut/cache_inst/mem_to_cache.rddata {-radix hexadecimal}} /tb_cpu/dut/cache_inst/mem_to_cache
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {229675 ps} 0}
...
update
WaveRestoreZoom {74822 ps} {448994 ps}
