...
add wave -noupdate -expand -group fetch -color Magenta -itemcolor Magenta -radix hexadecimal /tb_cpu/dut/pipeline_inst/fetch_inst/pc_new
...
add wave -noupdate -expand -group crtl /tb_cpu/dut/pipeline_inst/control_inst/res_n
add wave -noupdate -expand -group crtl /tb_cpu/dut/pipeline_inst/control_inst/stall
add wave -noupdate -expand -group crtl -group stall_out /tb_cpu/dut/pipeline_inst/control_inst/stall_fetch
add wave -noupdate -expand -group crtl -group stall_out /tb_cpu/dut/pipeline_inst/control_inst/stall_dec
add wave -noupdate -expand -group crtl -group stall_out /tb_cpu/dut/pipeline_inst/control_inst/stall_exec
add wave -noupdate -expand -group crtl -group stall_out /tb_cpu/dut/pipeline_inst/control_inst/stall_mem
add wave -noupdate -expand -group crtl -group stall_out /tb_cpu/dut/pipeline_inst/control_inst/stall_wb
add wave -noupdate -expand -group crtl -expand -group flush_out /tb_cpu/dut/pipeline_inst/control_inst/flush_fetch
add wave -noupdate -expand -group crtl -expand -group flush_out /tb_cpu/dut/pipeline_inst/control_inst/flush_dec
add wave -noupdate -expand -group crtl -expand -group flush_out /tb_cpu/dut/pipeline_inst/control_inst/flush_exec
add wave -noupdate -expand -group crtl -expand -group flush_out /tb_cpu/dut/pipeline_inst/control_inst/flush_mem
add wave -noupdate -expand -group crtl -expand -group flush_out /tb_cpu/dut/pipeline_inst/control_inst/flush_wb
add wave -noupdate -expand -group crtl -expand /tb_cpu/dut/pipeline_inst/control_inst/wb_op_exec
add wave -noupdate -expand -group crtl -expand /tb_cpu/dut/pipeline_inst/control_inst/exec_op_dec
add wave -noupdate -expand -group crtl /tb_cpu/dut/pipeline_inst/control_inst/pcsrc_in
add wave -noupdate -expand -group crtl /tb_cpu/dut/pipeline_inst/control_inst/pcsrc_out
...
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/op
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/A
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/W
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/R
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/XL
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/XS
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/D
add wave -noupdate -expand -group mem -group memu /tb_cpu/dut/pipeline_inst/memory_inst/memu_inst/M
...
WaveRestoreCursors {{Cursor 1} {46949 ps} 0}
