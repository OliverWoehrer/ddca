...
add wave -noupdate /tb/cache_inst/fsm/write_flag
...
add wave -noupdate -expand -group mgmt_st -expand -group mgmt_st_1w -expand /tb/cache_inst/mgmt_st_inst/mgmt_st_1w_inst/set_array
...
update
WaveRestoreZoom {171134 ps} {402134 ps}
